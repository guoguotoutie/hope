package com.hopeshop.order.utils;

import com.github.wxpay.sdk.WXPay;
import com.github.wxpay.sdk.WXPayConstants;
import com.hopeshop.order.config.PayConfig;
import com.hopeshop.order.service.OrderService;
...
public class PayHelper {
    ...
    public PayHelper() throws Exception {
        // 真实开发时
//        wxPay = new WXPay(payConfig);
    ...
    public String createPayUrl(Long orderId) {
        String key = "hopeshop.pay.url." + orderId;
        try {
        ...
        try {
            ...
            //回调地址
            data.put("notify_url", "http://test.hopeshop.com/wxpay/notify");
            // 交易类型为扫码支付
            data.put("trade_type", "NATIVE");
            //商品id,使用假数据
            data.put("product_id", "1234567");
            wxPay = new WXPay(payConfig, String.valueOf(WXPayConstants.SignType.MD5), true);
            //Map<String, String> result = this.wxPay.unifiedOrder(data);//真是环境使用
            //测试假数据
            Map<String, String> result = new HashMap<String, String>();
            result.put("return_code","SUCCESS");
            result.put("code_url","weixin://wxpay/bizpayurl/up?pr=NwY5Mz9&groupid=00");
    ...
    public PayState queryOrder(Long orderId) {
        ...
        try {
           ...
           result.put("trade_state","SUCCESS");//测试默认付款成功
