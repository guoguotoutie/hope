...
public class GoodsService {
    ...
    public void delGoods(Long id) {
        Spu spu = new Spu();
        spu.setId(id);
        this.spuMapper.deleteByPrimaryKey(spu);

        SpuDetail spuDetail = new SpuDetail();
        spuDetail.setSpuId(spu.getId());
        this.spuDetailMapper.deleteByPrimaryKey(spuDetail);
        ...
        list.forEach(sku1 -> {
            ...
            this.skuMapper.deleteByPrimaryKey(sku1.getId());
    ...
    @Transactional
    public void upsaleDown(Long id) {
        Spu spu = new Spu();
        spu.setId(id);
        Spu spu1 = this.spuMapper.selectByPrimaryKey(spu);
        spu1.setSaleable(false);
        this.spuMapper.updateByPrimaryKey(spu1);
    }

    @Transactional
    public void upsaleUp(Long id) {
        Spu spu = new Spu();
        spu.setId(id);
        Spu spu1 = this.spuMapper.selectByPrimaryKey(spu);
        spu1.setSaleable(true);
        this.spuMapper.updateByPrimaryKey(spu1);
    }
